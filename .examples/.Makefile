...
export LD_LIBRARY_PATH := ./sub/lib:./add/lib::$(LD_LIBRARY_PATH)

all: $(EXEDIR)/main1.exe $(EXEDIR)/main.exe 

$(EXEDIR)/main1.exe: $(BINDIR)/main1.o $(OBJS)
	$(CC) $(LINK_FLAGS) -Wl,-rpath=./sub/lib:./add/lib: $(BINDIR)/main1.o $(OBJS) -o $(EXEDIR)/main1.exe $(LIBPATH) $(EXTERN_LIBPATH) $(LIBS) $(EXTERN_LIBS)

$(EXEDIR)/main.exe: $(BINDIR)/main.o $(OBJS)
	$(CC) $(LINK_FLAGS) -Wl,-rpath=./sub/lib:./add/lib: $(BINDIR)/main.o $(OBJS) -o $(EXEDIR)/main.exe $(LIBPATH) $(EXTERN_LIBPATH) $(LIBS) $(EXTERN_LIBS)
